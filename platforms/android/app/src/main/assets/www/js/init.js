function init_setup(){
    ...
    //page_load(document.location); //on page load
    ...
    /* $('a').on('click',function(e){
        ...
        if(url_hash){
            e.stopPropagation();
            e.preventDefault();
            page_load($(this).prop('href'));
            if($(this).data('closemenu')){
    ...
    $('.close-sidebar, #page-content, .menu-item').not('.show-submenu').on('click', function(){      
